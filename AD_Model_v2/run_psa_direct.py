...
print("\n" + "="*80)
print("PSA WORKFLOW - MULTIPLE PREVALENCE LEVELS")
print("="*80)
...
# Get original population (needed for all prevalence runs)
...
for prevalence_idx, prevalence in enumerate(PREVALENCE_LEVELS, 1):
    ...
    OUTPUT_DIR = Path(f'psa_results_{prevalence_pct}')
...
periodontal disease prevalence set at {prevalence_pct}%. Given the computational demands of
...
for prev in PREVALENCE_LEVELS:
    ...
    print(f"\n{prev_pct}% Prevalence (psa_results_{prev_pct}/):")
