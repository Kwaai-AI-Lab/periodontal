"""
Direct PSA workflow with 1% population (no pilot study).
...
print("\n" + "="*80)
print("PSA WORKFLOW - 1% POPULATION METHOD")
print("="*80)
print(f"\nOutput directory: {OUTPUT_DIR.absolute()}")
print(f"PSA iterations: {PSA_ITERATIONS}")
...
# ============================================================================
# STEP 1: Configure PSA with 1% population
# ============================================================================
print("\n" + "="*80)
print("STEP 1: CONFIGURING PSA")
print("="*80 + "\n")

# Get original population
original_population = general_config.get('population', 33167098)
...
if psa_config.get('open_population', {}).get('use', False):
    ...
    psa_config['open_population']['entrants_per_year'] = scaled_entrants
    print(f"  - Entrants/year scaled: {original_entrants:,} -> {scaled_entrants:,}")

# ============================================================================
# STEP 2: Run PSA
# ============================================================================
print(f"\n" + "="*80)
print(f"STEP 2: RUNNING PSA ({PSA_ITERATIONS} ITERATIONS)")
print("="*80 + "\n")
...
try:
    ...
    # Save PSA results
    psa_file = OUTPUT_DIR / 'psa_results_1pct.pkl.gz'
...
# ============================================================================
print("\n" + "="*80)
print("STEP 3: SCALING RESULTS TO FULL POPULATION")
print("="*80 + "\n")
...
# ============================================================================
print("\n" + "="*80)
print("STEP 4: VALIDATING SCALING METHODOLOGY")
print("="*80 + "\n")
...
excel_file = OUTPUT_DIR / 'PSA_Results_Complete.xlsx'
...
# ============================================================================
print(f"\n" + "="*80)
print("STEP 6: METHODS JUSTIFICATION FOR MANUSCRIPT")
print("="*80 + "\n")

justification = f"""
METHODS SECTION TEXT - PROBABILISTIC SENSITIVITY ANALYSIS

We conducted probabilistic sensitivity analysis with {PSA_ITERATIONS} iterations to quantify
parameter uncertainty and its impact on model outcomes. Given the computational demands of
...
Results were scaled to the full UK population ({original_population:,}) by multiplying
...
Results scaled from {SCALE_FACTOR*100:.0f}% population to full UK population of
...
# ============================================================================
print(f"\n" + "="*80)
print("WORKFLOW COMPLETE - ALL FILES GENERATED")
print("="*80 + "\n")

print(f"Generated files in {OUTPUT_DIR.name}/:")
print(f"  1. psa_results_1pct.pkl.gz")
print(f"     -> PSA results with {PSA_ITERATIONS} iterations")
print(f"  2. PSA_Results_Complete.xlsx")
...
print("="*80)
print("\nNext steps:")
print("  1. Open PSA_Results_Complete.xlsx")
print("  2. Use 'Key_Results' sheet for main results table")
print("  3. Copy methods_justification.txt into manuscript")
print("  4. Report validation results from 'Validation' sheet")
print("  5. Include key statistics in methods (see justification file)")

print(f"\n" + "="*80)
print(f"Total runtime: {duration/60:.1f} minutes ({duration/3600:.2f} hours)")
print("="*80 + "\n")
