...
Edward James Brastock Coote, MSc (21D Clinical Limited)  (Corresponding author) 
...
**Conclusions:** NSPT is not  cost-effective for CVD prevention over 10 years but longer-term benefits may improve value. Uncertainty around treatment effects highlights the need for robust UK evidence.
...
| Parameter | Description | Deterministic Value | Reference |
|---|---|---|---|
| Baseline Hazards | Baseline Hazards | Baseline Hazards | Baseline Hazards |
| Base state stroke hazard | Annual stroke hazard in base state | 0.0336 | [1] |
| Base state CHD hazard | Annual MI hazard in base state | 0.0463 | [2] |
| Background death hazard | Annual background death hazard | 0.0126 | [3] |
| Case Fatality Rates | Case Fatality Rates | Case Fatality Rates | Case Fatality Rates |
| Stroke fatality | Fatal fraction of stroke events in cycle | 0.1 | [4] |
| CHD fatality | Fatal fraction of MI events in cycle | 0.14 | [5] |
| Hazard multipliers by state | Hazard multipliers by state | Hazard multipliers by state | Hazard multipliers by state |
| Stroke Post-Stroke Y1 | How much higher the stroke hazard becomes after prior Y1 stroke | 1.36 | [6] |
| Stroke Post-Stroke Y2 | How much higher the stroke hazard becomes after prior Y2 stroke | 1.36 | [6] |
| CHD Post CHD Y1 | How much higher the MI hazard becomes after prior Y1 MI | 1.19 | [6] |
| CHD Post CHD Y2 | How much higher the MI hazard becomes after prior Y2 MI | 1.19 | [6] |
| Stroke Post Both Y1 | How much higher the stroke hazard becomes after prior Y1 both | 1.94 | [6] |
| Stroke Post Both Y2 | How much higher the stroke hazard becomes after prior Y2 both | 1.94 | [6] |
| CHD Post Both Y1 | How much higher the MI hazard becomes after prior Y1 both | 1.94 | [6] |
| CHD Post Both Y2 | How much higher the MI hazard becomes after prior Y2 both | 1.94 | [6] |
| Utilities | Utilities | Utilities | Utilities |
| Base | Distinct utility values for each state | 0.83 | [7] |
| Post-Stroke Y1 | Distinct utility values for each state | 0.7 | [7] |
| Post-Stroke Y2 | Distinct utility values for each state | 0.68 | [7] |
| Post CHD Y1 | Distinct utility values for each state | 0.77 | [7] |
| Post CHD Y2 | Distinct utility values for each state | 0.74 | [7] |
| Post Both Y1 | Distinct utility values for each state | 0.54 | Multiplicative approach |
| Post Both Y2 | Distinct utility values for each state | 0.50 | Multiplicative approach |
| Dead | Distinct utility values for each state | 0 |  |
| Disutility of stroke event | Disutility for acute CVD events | -0.59 | [8] |
| Disutility of CHD event | Disutility for acute CVD events | -0.03 | [9] |
...
|  | Base (no prior CVD) | Post-Stroke (Y1) | Post-Stroke (Y2) | Post-CHD (Y1) | Post-CHD (Y2) | Post-Both (Y1) | Post-Both (Y2) | Dead (absorbing) |
|---|---|---|---|---|---|---|---|---|
| Base Arm | Base Arm | Base Arm | Base Arm | Base Arm | Base Arm | Base Arm | Base Arm | Base Arm |
...
| Procedure | Labour Cost (£) | Laboratory Cost (£) | Total Cost (£) | Expected amount per cycle (1 year) | Expected cost per cycle (£) |
|---|---|---|---|---|---|
...
| State | Value from source (year) | Deterministic 2024 Value (£) | Description | Reference |
|---|---|---|---|---|
...
| Dead | 0 | 0 | - | N/a |
| Stroke event (one-off) | 3,061.20 (2003) | 5,240.77 | Cost to the NHS over 5 years was £15,306, which we divided by 5 to give the single year cost. The cost inflator value was 1.712. | [11] |
...
| Parameter | Deterministic Value | CI for one-way sensitivity analysis | Parameter Distribution | Probabilistic sensitivity analysis | Probabilistic sensitivity analysis |
|---|---|---|---|---|---|
|  |  |  |  | α | β |
| Baseline Hazards |  |  |  |  |  |
...
| Case Fatality Rates | Case Fatality Rates | Case Fatality Rates | Case Fatality Rates | Case Fatality Rates | Case Fatality Rates |
| Stroke fatality | 0.1 | (0.09-0.11) | Beta | 1 | 3 |
| CHD fatality | 0.14 | (0.126-0.154) | Beta | 1 | 4 |
| Hazard Multipliers by state | Hazard Multipliers by state | Hazard Multipliers by state | Hazard Multipliers by state | Hazard Multipliers by state | Hazard Multipliers by state |
...
| Treatment Effects | Treatment Effects | Treatment Effects | Treatment Effects | Treatment Effects | Treatment Effects |
...
[3] Office for National Statistics. *National Life Tables: UK* [Internet]. London, England: Office for National Statistics; March 18, 2025. Accessed October 23, 2025. Available from:  
